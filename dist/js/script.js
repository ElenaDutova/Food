...
window.addEventListener('DOMContentLoaded', () => {
  ...
  const modalBtns = document.querySelectorAll('[data-modal]'),
        ...
        modalWindow = document.querySelector('.modal'); // Создание модального окна с помощью инлайн стилей:
  ...
  window.addEventListener('scroll', showModalByScroll); // Создание карточек меню с помощью классов
